...
(function () {
  ...
  const freeGlobalThis = isNotFirefoxContentScriptEnviroment(
    typeof globalThis == "object" && globalThis
  );
  const freeWindow = isNotFirefoxContentScriptEnviroment(
    typeof window == "object" && window
  );
  const freeSelf = isNotFirefoxContentScriptEnviroment(
    typeof self == "object" && self
  );
  const freeGlobal = isNotFirefoxContentScriptEnviroment(
